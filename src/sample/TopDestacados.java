...
public class TopDestacados {
    ...
    public TopDestacados(String nombre, String apellido, String edad, String departamento, String ocupacion, String banco, String sucursal_favorita, String categoria_favorita) {
        this.nombre = nombre;
        this.apellido = apellido;
        this.edad = edad;
        this.departamento = departamento;
